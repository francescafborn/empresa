...
public class DaoEmpresa {
     public static boolean inserir(Empresa objeto) {
      ...
      public static void main(String[] args) {
        ...
        objeto.setRazao_social("Cooperativa etc de alimentos e grãos");
        objeto.setNome_fantasia("Cooperafood");
       ...
       public static boolean alterar(Empresa objeto) {
        ...
        //editar o SQL conforme a entidade
        String sql = "SELECT razao_social, nome_fantasia FROM empresa WHERE codigo=?";
        PreparedStatement ps;
        try {
            ps = conexao.Conexao.getConexao().prepareStatement(sql);
